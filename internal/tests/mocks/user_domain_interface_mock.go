...
// Source: C:\Users\roger\Documents\RS-SISTEMAS-2022\Aplicações\crud-go\internal\model\user_domain_interface.go
//
// Generated by this command:
//
//	mockgen.exe -source=C:\Users\roger\Documents\RS-SISTEMAS-2022\Aplicações\crud-go\internal\model\user_domain_interface.go -destination=C:\Users\roger\Documents\RS-SISTEMAS-2022\Aplicações\crud-go\internal\tests\mocks\user_domain_interface_mock.go -package=mocks
//
...
func (m *MockUserDomainInterface) CheckPasswordHash(arg0 string) bool {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CheckPasswordHash", arg0)
	ret0, _ := ret[0].(bool)
	return ret0
}

// CheckPasswordHash indicates an expected call of CheckPasswordHash.
func (mr *MockUserDomainInterfaceMockRecorder) CheckPasswordHash(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckPasswordHash", reflect.TypeOf((*MockUserDomainInterface)(nil).CheckPasswordHash), arg0)
}
...
func (m *MockUserDomainInterface) GetAge() int {
	m.ctrl.T.Helper()
